...
if __name__ == "__main__":
    ...
    parser.add_argument("--val_images_names_full_path", default="./metadata/experiment_2_1_images.csv")
    ...
    parser.add_argument("--output_parent_path", default="./experiment_2_1_results")
